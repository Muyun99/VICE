...
from tools_transformer.helpers import load_pretrained
from tools_transformer.weight_init import trunc_normal_
from tools_transformer.layer_helpers import to_2tuple
    ...
    def relprop(self, cam=None, method="transformer_attribution", is_ablation=False, start_layer=0, **kwargs):
        ...
        if method == "full":
            ...
            for blk in self.blocks:
                ...
                avg_heads = (attn_heads.sum(dim=1) /
                             attn_heads.shape[1]).detach()
...
def vit_small_patch32_224(pretrained=False, **kwargs):
    ...
    model = VisionTransformer(mlp_ratio=4, qkv_bias=True, **model_kwargs)
    return model
