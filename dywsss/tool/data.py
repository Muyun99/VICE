...
class VOC12ImageDataset(Dataset):
    ...
    def __init__(self, img_name_list_path, voc12_root, transform=None, img_name_list=None):
        self.img_name_list = []
        if img_name_list is not None:
            self.img_name_list = img_name_list
        elif img_name_list_path != '':
...
class VOC12ClsDataset(VOC12ImageDataset):
    ...
    def __init__(self, img_name_list_path, voc12_root, transform=None, pseudo_gt="", img_name_list=None):
        super().__init__(img_name_list_path, voc12_root, transform, img_name_list)
        try:
